...
To define what Formula Complexity really is we have to explain exactly what operators
are acceptable in each formula.
Our formula include the logical operators and , or , not in addition to the mathematical
ones + , * . Acceptable inputs to the formula are 0 , 1 , x , y .
Once you have all the necessary building blocks one merely needs to enumerate all
possible combinations given the set of all acceptable operators and you have all possible 
formulae. Formula Complexity now has a frame of reference in which to exist.
